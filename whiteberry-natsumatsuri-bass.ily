...
sectionI = \repeat volta 2 {
  \tag #'score \compressMMRests R1*9 |
  \tag #'(midi video) R1*9 |
}

sectionCodaTwo = {
  \sectionDOne
  f8 f ees\3 ees\3 b b bes bes |
}

sectionCodaThree = {
  \sectionDOne
  \repeat percent 2 \sectionBOne
}

sectionJ = {
  \tag #'score \compressMMRests R1*4 |
  \tag #'(midi video) R1*4 |
}
